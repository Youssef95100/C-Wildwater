...
2.1. Ajouter le fichier c-wildwater_v3.dat (ou le fichier que vous souhaitez analyser);Le fichier de données étant trop volumineux pour GitHub (500 Mo), il doit être ajouté manuellement.
